...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Mostrar _MENU_ registros",sZeroRecords:"Ninguna coincidencia encontrada.",sEmptyTable:"No hay datos disponibles.",
sLoadingRecords:"Loading...",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ registros.",sInfoEmpty:"Mostrando 0 a 0 de 0 registros.",sInfoFiltered:"(filtrado de _MAX_ registros totales)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primera",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Ultima"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
